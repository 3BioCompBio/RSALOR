...
setup(
    ...
    description="Combine Structural (Relative Solvent Accessibility) and Evolutionary (Log Odd Ratio extracted from the MSA) information to evaluate missence mutations of proteins.",
